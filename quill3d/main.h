...
class spatial_region
{
    ...
    void f_init_cos(double,double,double,double,double,double,bool,bool,double,double,double,double,bool,double,double,double,double);
    void f_init_focused(double,double,double,double,double,double,bool,double,double,double,bool,double,bool,double,double,double,double);
