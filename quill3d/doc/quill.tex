...
This document describes how the formulas used in the lecture notes \cite{PukhovLectures} and the paper \cite{PukhovCERN} by Prof. Pukhov, which are used as a basis for Quill, are applied in Quill.
